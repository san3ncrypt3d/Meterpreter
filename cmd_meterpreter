...
Meterpreter is very likely a Linux terminal and so are the commands very similar in nature. As such, many of our basic Linux commands can be used on the meterpreter even if it’s on a Windows or other operating system.
